...
const faqSchema = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    {"@type":"Question","name":"Ist IPTV Smarters Pro kostenlos?","acceptedAnswer":{"@type":"Answer","text":"Ja, IPTV Smarters Pro ist vollständig kostenlos. Sie laden die App aus dem jeweiligen App Store und geben dann Ihre IPTVV-Zugangsdaten ein. Es fallen keine zusätzlichen App-Kosten an."}},
    ...
    {"@type":"Question","name":"Was ist der Unterschied zwischen M3U und Xtream Codes?","acceptedAnswer":{"@type":"Answer","text":"Xtream Codes API ist die empfohlene Methode für IPTVV – sie ermöglicht schnelleres Laden, VOD-Bibliotheken und EPG. M3U ist eine einfache Playlist-URL. Beides funktioniert mit Smarters Pro."}}
  ],
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'IPTV Smarters Pro Deutschland', item: 'https://iptvv.de/iptv-smarters-pro-deutschland' },
  ],
}
      ...
      <div style={{ background: '#0a0a0a', minHeight: '100vh', color: '#fff' }}>
        <nav style={{ background: '#0a0a0a', borderBottom: '1px solid #1a1a1a', position: 'fixed', top: 0, left: 0, right: 0, zIndex: 50, height: '64px', display: 'flex', alignItems: 'center' }}>
          <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
            ...
            <a href={`${WA}&text=Hallo+IPTVV%2C+ich+möchte+IPTV+Smarters+Pro+mit+IPTVV+einrichten`} target="_blank" rel="noopener noreferrer"
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', padding: '100px 16px 80px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div key="02" style={{ display: 'flex', gap: '20px', alignItems: 'flex-start', background: '#111', border: '1px solid #1e1e1e', borderRadius: '12px', padding: '24px' }}>
                ...
                <div>
                  ...
                  <p style={{ color: '#8c8c8c', fontSize: '0.9rem', lineHeight: 1.7 }}>Wählen Sie Ihr IPTVV-Paket und erhalten Sie Server-URL, Benutzername und Passwort per WhatsApp.</p>
                </div>
              </div>
          ...
          <section style={{ marginBottom: '56px' }}>
            ...
            <div key="Ist IPTV Smarters Pro kostenlo" style={{ background: '#111', border: '1px solid #1e1e1e', borderRadius: '10px', padding: '20px' }}>
              ...
              <p style={{ color: '#8c8c8c', fontSize: '0.88rem', lineHeight: 1.7 }}>Ja, IPTV Smarters Pro ist vollständig kostenlos. Sie laden die App aus dem jeweiligen App Store und geben dann Ihre IPTVV-Zugangsdaten ein. Es fallen keine zusätzlichen App-Kosten an.</p>
            </div>
            ...
            <div key="Was ist der Unterschied zwisch" style={{ background: '#111', border: '1px solid #1e1e1e', borderRadius: '10px', padding: '20px' }}>
              ...
              <p style={{ color: '#8c8c8c', fontSize: '0.88rem', lineHeight: 1.7 }}>Xtream Codes API ist die empfohlene Methode für IPTVV – sie ermöglicht schnelleres Laden, VOD-Bibliotheken und EPG. M3U ist eine einfache Playlist-URL. Beides funktioniert mit Smarters Pro.</p>
            </div>
            </div>
          </section>
