...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'FAQ', item: 'https://iptvv.de/faqs' },
  ],
}
...
export default function FAQs() {
  return (
    <>
      <Head>
        <title>IPTV FAQ – Häufige Fragen zu IPTV Deutschland | IPTVV.DE</title>
        <meta name="description" content="Antworten auf alle Fragen zu IPTV in Deutschland: kompatible Geräte, Smarters Pro, Bundesliga, Aktivierung, Internetgeschwindigkeit und mehr. IPTVV.DE erklärt alles." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://iptvv.de/faqs" />
        <meta property="og:title" content="IPTV FAQ – Häufige Fragen zu IPTV Deutschland | IPTVV.DE" />
        <meta property="og:description" content="Alle Antworten zu IPTV in Deutschland: Geräte, Smarters Pro, Aktivierung und mehr." />
        <meta property="og:url" content="https://iptvv.de/faqs" />
